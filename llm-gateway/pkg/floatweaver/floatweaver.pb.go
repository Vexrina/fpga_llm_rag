...
func (x *EmbedRequest) Reset() {
	*x = EmbedRequest{}
	mi := &file_floatweaver_proto_msgTypes[0]
...
func (*EmbedRequest) Descriptor() ([]byte, []int) {
	return file_floatweaver_proto_rawDescGZIP(), []int{0}
}
...
func (x *EmbedResponse) Reset() {
	*x = EmbedResponse{}
	mi := &file_floatweaver_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EmbedResponse) Descriptor() ([]byte, []int) {
	return file_floatweaver_proto_rawDescGZIP(), []int{1}
}
...
func (x *Embedding) Reset() {
	*x = Embedding{}
	mi := &file_floatweaver_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Embedding) Descriptor() ([]byte, []int) {
	return file_floatweaver_proto_rawDescGZIP(), []int{2}
}
...
var File_floatweaver_proto protoreflect.FileDescriptor

const file_floatweaver_proto_rawDesc = "" +
	"\n" +
	"\x11floatweaver.proto\x12\vfloatweaver\"\"\n" +
...
var (
	file_floatweaver_proto_rawDescOnce sync.Once
	file_floatweaver_proto_rawDescData []byte
)

func file_floatweaver_proto_rawDescGZIP() []byte {
	file_floatweaver_proto_rawDescOnce.Do(func() {
		file_floatweaver_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_floatweaver_proto_rawDesc), len(file_floatweaver_proto_rawDesc)))
	})
	return file_floatweaver_proto_rawDescData
}

var file_floatweaver_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_floatweaver_proto_goTypes = []any{
...
var file_floatweaver_proto_depIdxs = []int32{
...
func init() { file_floatweaver_proto_init() }
func file_floatweaver_proto_init() {
	if File_floatweaver_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_floatweaver_proto_rawDesc), len(file_floatweaver_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_floatweaver_proto_goTypes,
		DependencyIndexes: file_floatweaver_proto_depIdxs,
		MessageInfos:      file_floatweaver_proto_msgTypes,
	}.Build()
	File_floatweaver_proto = out.File
	file_floatweaver_proto_goTypes = nil
	file_floatweaver_proto_depIdxs = nil
}
